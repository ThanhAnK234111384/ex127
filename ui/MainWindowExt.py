...
import pandas as pd
from ex127.ui.MainWindow import Ui_MainWindow
...
class MainWindowEx(Ui_MainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButtonStatistics.clicked.connect(self.group_and_statistics)
        self.pushButtonDel.clicked.connect(self.delete_by_symbol)
